...
#sed -e 's/http\:\/\/publications\.europa\.eu\/resource\/cellar/http\:\/\/publications\.europa\.eu\/resource\/cellar\/'$i'\/gen/g' $filepath > $dirOut/$filenoext'_gen_10_.nq'
sed -e 's/http\:\/\/publications\.europa\.eu\/resource\/cellar/http\:\/\/publications\.europa\.eu\/resource\/cellar\/'$i'\/gen/g' $filepath > $dirOut/$filenoext'_gen_11_.nq'
