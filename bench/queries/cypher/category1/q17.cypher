...
Where
    ...
    and n_cellarId.`measure_national_implementing_implements_resource_legal`= $celex1
Return 
    ...
    coalesce(n_transposition_deadline_transmitted.id, "1001-01-01") as transposition_deadline,
    count(*) as count 
Order By 
    n_country.id, 
    n_nimId.id    