// credit: François Vanderseyoen , Neo4J
// May 31, 2022 
...
Where
// regex - modified to nim not him initially
    n_nimId.id =~ '(.*?)resource\/nim(.*?)'
